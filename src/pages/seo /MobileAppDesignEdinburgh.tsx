    ...
    <div className="bg-white text-neutral-800 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 md:px-10 py-20 space-y-10 leading-relaxed">
        ...
        <section className="space-y-6">
          <p>Edinburgh's tech ecosystem is innovative and fast-growing, but competition is fierce. You need more than just a pretty interface—you need a product that retains users, scales fast, and stands out in the App Store. You're building something that matters, and every design decision counts.</p>
          <p className="font-medium">A custom mobile app puts your brand in their pocket—delivering value, engagement, and loyalty with every tap. <strong>Pro tip:</strong> The fastest-growing Edinburgh apps focus on onboarding clarity and micro-interactions that delight users from the first screen.</p>
        </section>
        {/* Feature Set */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-orange-500">📱 Features for Edinburgh Innovators</h2>
        ...
        {/* Our Process */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-orange-500">🛠️ Our Edinburgh App Design Process</h2>
        ...
        {/* Who It's For */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-orange-500">🎯 Perfect for These Edinburgh Businesses</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section className="space-y-4 text-sm text-gray-600">
          <p>✅ <strong>Believe in the Product:</strong> Our apps boost engagement, retention, and revenue—built for Edinburgh's pace. <strong>Pro tip:</strong> Use in-app feedback loops to iterate fast and keep users loyal.</p>
          <p>✅ <strong>Trust the Team:</strong> Nivk's designers and developers have launched successful apps for Edinburgh startups and global brands. Our client in Paris increased conversions by 32% after we simplified their onboarding screen.</p>
          <p>✅ <strong>Trust the Company:</strong> Nivk.com is a values-driven agency with a track record of results in Scotland and beyond.</p>
        </section>
        {/* Backend Dev Upsell */}
        <section className="space-y-6">
        ...
        <section className="space-y-4">
          <blockquote className="italic border-l-4 border-orange-400 pl-4">
            "Our app launch in Edinburgh was a hit—Nivk's design made all the difference."<br />
            <span className="text-sm text-gray-500">– Fictional Client, EdinburghTech</span>
          </blockquote>
        </section>
        {/* Internal Links */}
